...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (47.22°N for Nantes/Loire-Atlantique)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(47.22°) ≈ 75.46 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 75.46;
